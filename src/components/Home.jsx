...
const Home = () => {
  return (
    <div className='bg-neutralSilver'>
        <div className='lg:px-14 px-5 max-w-screen-2xl mx-auto min-h-screen h-screen'>
            <div className="my-20  py-20 flex flex-col lg:flex-row-reverse items-center justify-between gap-12">
                ...
                <div className='lg:text-left text-center'>
                    <h1 className='text-3xl xl:text-6xl md:text-5xl font-semibold mb-4 text-neutralDGrey lg:w-3/4 leading-snug'>
                        Интегратор
                    ...
                    <p className='text-neutralGrey text-lg xl:text-xl md:text-lg leading-8 mb-8 mx-auto lg:mx-0' style={{maxWidth: '650px'}}>
